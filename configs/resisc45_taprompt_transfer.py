...
def get_args_parser(subparsers):
    ...
    # ✅ 添加 LEEP 相关参数
    subparsers.add_argument('--leep_warmup_batches', default=5, type=int,
                        help='batches for LEEP warmup in evaluation')
    subparsers.add_argument('--leep_weight', default=0.5, type=float,
                        help='Weight for LEEP in evaluation (0=only logits, 1=only LEEP)')
    subparsers.add_argument('--leep_hard_selection', default=True, type=bool,
                            help='Use hard selection (only max LEEP task gets weight 1)')
    # ✅ 添加 task_embedding 相关参数
    subparsers.add_argument('--use_task_embedding_bias', action='store_true', help='use_task_embedding_bias')#use_task_embedding_bias
    ...
    subparsers.add_argument('--dataset', default='Split-RESISC45-transfer', type=str, help='dataset name')
    ...
    subparsers.add_argument('--eval', action='store_true', help='Perform evaluation only')#use_task_embedding_bias
    ...
    # TAPrompt Parameters
    subparsers.add_argument('--trained_taprompt_model', type=str, default='', help='Trained TAPrompt Model for Evaluation')
    subparsers.add_argument('--ckpt_num', type=int, default=0, help='Task of Trained TAPrompt Model')
